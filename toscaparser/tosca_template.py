...
SECTIONS = (DEFINITION_VERSION, DEFAULT_NAMESPACE, TEMPLATE_NAME,
            ...
            POLICY_TYPES, GROUP_TYPES, REPOSITORIES, METADATA) = \
           ('tosca_definitions_version', 'tosca_default_namespace',
            ...
            'interface_types', 'policy_types', 'group_types', 'repositories', 'metadata')
...
class ToscaTemplate(object):
    ...
    VALID_TEMPLATE_VERSIONS = ['tosca_simple_yaml_1_0', 'tosca_simple_yaml_1_1']
